...
def remove_cycle_edges_by_mfas(graph_file):
    ...
    edges_to_be_removed_file = graph_file[:len(
        graph_file)-6] + "_removed_by_mfas.edges"
    write_pairs_to_file(edges_to_be_removed, edges_to_be_removed_file)
    return edges_to_be_removed


def mfas_to_be_removed(graph_file, gt_edges_file):
    return remove_cycle_edges_by_mfas(graph_file)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--gt_edges_file",
                        default=None, help="ground truth edges")
